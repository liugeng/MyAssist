//------------------------------------------------------------------------------
// <copyright file="CommandsPackage.cs" company="Microsoft">
...
namespace MyAssist
{
    ...
    public sealed class CommandsPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "55a4db80-24b2-4864-a761-67b008517ee3";
        ...
        {
            Cmd_FindInFiles.Initialize(this);
            Cmd_OpenAsFile.Initialize(this);
            base.Initialize();
        }
